    ...
    <div id="main-front" class="front-hero">
        ...
        <div class="hero-container">
            ...
            <div class="hero-images">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero/1.png " class="active" style="z-index: 3">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero/2.png " style="z-index: 2">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero/3.png " style="z-index: 1">
            </div>
